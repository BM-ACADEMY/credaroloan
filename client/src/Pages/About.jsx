...
const CredaroAboutSection = () => {
  ...
  return (
    <>
      <section className="relative w-full py-20 px-4 md:px-8 bg-gray-50 flex items-center justify-center overflow-hidden" id='about'>
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <button 
                ...
                className="bg-[#00C4CC] hover:bg-[#00b0b8] text-white px-8 py-4 font-bold uppercase tracking-wider text-sm flex items-center gap-2 transition-colors duration-300 w-fit"
              >
                  Know About Us 
